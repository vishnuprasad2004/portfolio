...
const ProjectModal: React.FC<ProjectModalProps> = ({ open, onClose, project }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-neutral-900 text-white rounded-2xl max-w-3xl w-full mx-0 md:mx-4 overflow-hidden shadow-xl">
        <div className="flex items-start justify-between p-4 border-b border-neutral-800">
          <div>
            <h3 className="text-lg font-bold">{project.title}</h3>
            {project.latest && <span className="text-xs rounded-md px-2 py-1 bg-green-500/10 text-green-500">New</span>}
          </div>
        ...
        <div className="max-h-[70vh] overflow-y-auto">
          <div className="p-4 grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div className="md:col-span-3 text-sm text-neutral-200">
              ...
              <div className="mb-3">
                <h4 className="text-sm text-left font-semibold mb-2">Technologies Used</h4>
