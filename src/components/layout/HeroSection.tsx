    ...
    return (
        <div className="h-screen flex justify-center items-center" id="hero">
          <div className="flex flex-col justify-center items-center w-screen">
            ...
            <span className={spaceMono.className + " lg:text-8xl select-none text-3xl my-name brightness-150"} style={{ fontFamily: fontClassNames[currentFontIdx] }}>VishnuPrasadKorada™</span>
