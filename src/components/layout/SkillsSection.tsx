...
const SkillChip: React.FC<SkillChipProps> = ({ skillName }) => {
  return (
    <div className="opacity-0 skill flex flex-row items-center justify-center gap-1 bg-[#FFB355]/55 pl-4 pr-4 text-base rounded-full border-[#FFB355] border-2 border-solid">
    ...
    return (
        <div id="skills" className={spaceMono.className + " lg:text-3xl text-xl text-center lg:h-screen h-screen mb-10 w-screen flex flex-col justify-center items-center lg:pl-44 lg:pr-44"}>
          ...
          <div className="flex flex-wrap gap-2 p-5 text-5xl justify-center items-center" id="skills-container">
              {skills.map((skill, idx) => <SkillChip skillName={skill} key={idx}/>)}
